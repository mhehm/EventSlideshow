 ...
 * @since       1.6
 */
class EventslideshowControllerEvent extends JControllerForm
{
	/**
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_eventslideshow&view=events' . $this->getRedirectToListAppend(), false));
